...
class CameraRig:
    ...
    def __init__(self, cameras, vessel=None, include_wave=True, wave_induced_camera_disturbance_coef=1):
        '''
        Input:
        ...
        if self.include_wave:
            self.wave_motion = WaveMotion(wave_induced_camera_disturbance_coef)  
        self.horizon = {}
